...
export function AppSidebar() {
  ...
  return (
    <aside
      className={cn(
        "fixed top-0 left-0 h-screen bg-sidebar text-sidebar-foreground flex flex-col transition-all duration-300 ease-in-out border-r border-sidebar-border z-40",
        collapsed ? "w-16" : "w-64"
      )}
    >
      {/* Logo */}
