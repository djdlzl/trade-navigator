...
// Temporary signup mode flag - set to false after creating admin account
const ENABLE_TEMP_SIGNUP = true;
          ...
          {ENABLE_TEMP_SIGNUP ? (
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-4">
                ...
                <TabsTrigger value="signup">관리자 생성</TabsTrigger>
              </TabsList>
